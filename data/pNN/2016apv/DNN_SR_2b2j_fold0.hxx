//Code generated automatically by TMVA for Inference of Model file [DNN_SR_2b2j_fold0.onnx] at [Tue Nov  5 15:21:37 2024] 
...
std::vector<float> fTensor_linearrelustack3bias = std::vector<float>(8);
...
std::vector<float> fTensor_input7 = std::vector<float>(8);
...
std::vector<float> fTensor_input11 = std::vector<float>(8);
...
//--------- Gemm
   ...
   int op_2_lda = 128;
   int op_2_ldb = 128;
   std::copy(tensor_linearrelustack3bias, tensor_linearrelustack3bias + 8, tensor_input7);
