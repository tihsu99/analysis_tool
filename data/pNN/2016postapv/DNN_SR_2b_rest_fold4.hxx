//Code generated automatically by TMVA for Inference of Model file [DNN_SR_2b_rest_fold4.onnx] at [Tue Nov  5 15:21:58 2024] 

#ifndef TMVA_SOFIE_DNN_SR_2B_REST_FOLD4
#define TMVA_SOFIE_DNN_SR_2B_REST_FOLD4
...
namespace TMVA_SOFIE_DNN_SR_2b_rest_fold4{
namespace BLAS{
...
std::vector<float> fTensor_linearrelustack6weight = std::vector<float>(1024);
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "DNN_SR_2b_rest_fold4.dat";
   std::ifstream f;
   f.open(filename);
   if (!f.is_open()){
...
} //TMVA_SOFIE_DNN_SR_2b_rest_fold4

#endif  // TMVA_SOFIE_DNN_SR_2B_REST_FOLD4
