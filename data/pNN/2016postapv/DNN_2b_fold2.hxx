//Code generated automatically by TMVA for Inference of Model file [DNN_2b_fold2.onnx] at [Wed Sep 25 03:12:36 2024] 

#ifndef TMVA_SOFIE_DNN_2B_FOLD2
#define TMVA_SOFIE_DNN_2B_FOLD2
...
namespace TMVA_SOFIE_DNN_2b_fold2{
namespace BLAS{
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "DNN_2b_fold2.dat";
   std::ifstream f;
   f.open(filename);
   if (!f.is_open()){
...
} //TMVA_SOFIE_DNN_2b_fold2

#endif  // TMVA_SOFIE_DNN_2B_FOLD2
