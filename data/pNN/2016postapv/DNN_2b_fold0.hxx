//Code generated automatically by TMVA for Inference of Model file [DNN_2b_fold0.onnx] at [Wed Sep 25 03:12:14 2024] 

#ifndef TMVA_SOFIE_DNN_2B_FOLD0
#define TMVA_SOFIE_DNN_2B_FOLD0
...
namespace TMVA_SOFIE_DNN_2b_fold0{
namespace BLAS{
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "DNN_2b_fold0.dat";
   std::ifstream f;
   f.open(filename);
   if (!f.is_open()){
...
} //TMVA_SOFIE_DNN_2b_fold0

#endif  // TMVA_SOFIE_DNN_2B_FOLD0
