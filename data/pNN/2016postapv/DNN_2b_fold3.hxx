//Code generated automatically by TMVA for Inference of Model file [DNN_2b_fold3.onnx] at [Wed Sep 25 03:12:30 2024] 
...
namespace TMVA_SOFIE_DNN_2b_fold3{
namespace BLAS{
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "DNN_2b_fold3.dat";
   std::ifstream f;
   f.open(filename);
   if (!f.is_open()){
...
} //TMVA_SOFIE_DNN_2b_fold3

#endif  // TMVA_SOFIE_DNN_2B_FOLD3
