//Code generated automatically by TMVA for Inference of Model file [DNN_2b_fold1.onnx] at [Mon Jul  1 07:57:27 2024] 
...
Session(std::string filename ="") {
   ...
   if (length != 1664) {
      std::string err_msg = "TMVA-SOFIE failed to read the correct tensor size; expected size is 1664 , read " + std::to_string(length) ;
      throw std::runtime_error(err_msg);
    }
    for (int i =0; i < length; ++i) 
