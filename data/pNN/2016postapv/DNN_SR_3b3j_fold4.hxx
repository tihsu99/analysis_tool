//Code generated automatically by TMVA for Inference of Model file [DNN_SR_3b3j_fold4.onnx] at [Tue Nov  5 15:21:48 2024] 

#ifndef TMVA_SOFIE_DNN_SR_3B3J_FOLD4
#define TMVA_SOFIE_DNN_SR_3B3J_FOLD4
...
namespace TMVA_SOFIE_DNN_SR_3b3j_fold4{
namespace BLAS{
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "DNN_SR_3b3j_fold4.dat";
   std::ifstream f;
   f.open(filename);
   if (!f.is_open()){
...
} //TMVA_SOFIE_DNN_SR_3b3j_fold4

#endif  // TMVA_SOFIE_DNN_SR_3B3J_FOLD4
