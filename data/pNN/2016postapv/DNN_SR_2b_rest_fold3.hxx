//Code generated automatically by TMVA for Inference of Model file [DNN_SR_2b_rest_fold3.onnx] at [Tue Nov  5 15:21:45 2024] 

#ifndef TMVA_SOFIE_DNN_SR_2B_REST_FOLD3
#define TMVA_SOFIE_DNN_SR_2B_REST_FOLD3
...
namespace TMVA_SOFIE_DNN_SR_2b_rest_fold3{
namespace BLAS{
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "DNN_SR_2b_rest_fold3.dat";
   std::ifstream f;
   f.open(filename);
   if (!f.is_open()){
...
} //TMVA_SOFIE_DNN_SR_2b_rest_fold3

#endif  // TMVA_SOFIE_DNN_SR_2B_REST_FOLD3
