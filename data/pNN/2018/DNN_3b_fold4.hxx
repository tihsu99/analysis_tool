//Code generated automatically by TMVA for Inference of Model file [DNN_3b_fold4.onnx] at [Wed Sep 25 03:12:19 2024] 

#ifndef TMVA_SOFIE_DNN_3B_FOLD4
#define TMVA_SOFIE_DNN_3B_FOLD4
...
namespace TMVA_SOFIE_DNN_3b_fold4{
namespace BLAS{
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "DNN_3b_fold4.dat";
   std::ifstream f;
   f.open(filename);
   if (!f.is_open()){
...
} //TMVA_SOFIE_DNN_3b_fold4

#endif  // TMVA_SOFIE_DNN_3B_FOLD4
