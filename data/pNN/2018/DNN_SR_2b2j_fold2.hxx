//Code generated automatically by TMVA for Inference of Model file [DNN_SR_2b2j_fold2.onnx] at [Tue Nov  5 15:21:51 2024] 

#ifndef TMVA_SOFIE_DNN_SR_2B2J_FOLD2
#define TMVA_SOFIE_DNN_SR_2B2J_FOLD2
...
namespace TMVA_SOFIE_DNN_SR_2b2j_fold2{
namespace BLAS{
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "DNN_SR_2b2j_fold2.dat";
   std::ifstream f;
   f.open(filename);
   if (!f.is_open()){
...
} //TMVA_SOFIE_DNN_SR_2b2j_fold2

#endif  // TMVA_SOFIE_DNN_SR_2B2J_FOLD2
