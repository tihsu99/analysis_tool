//Code generated automatically by TMVA for Inference of Model file [DNN_SR_2b2j_fold1.onnx] at [Tue Nov  5 15:21:45 2024] 

#ifndef TMVA_SOFIE_DNN_SR_2B2J_FOLD1
#define TMVA_SOFIE_DNN_SR_2B2J_FOLD1
...
namespace TMVA_SOFIE_DNN_SR_2b2j_fold1{
namespace BLAS{
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "DNN_SR_2b2j_fold1.dat";
   std::ifstream f;
   f.open(filename);
   if (!f.is_open()){
...
} //TMVA_SOFIE_DNN_SR_2b2j_fold1

#endif  // TMVA_SOFIE_DNN_SR_2B2J_FOLD1
