//Code generated automatically by TMVA for Inference of Model file [DNN_3b_fold3.onnx] at [Wed Sep 25 03:12:25 2024] 

#ifndef TMVA_SOFIE_DNN_3B_FOLD3
#define TMVA_SOFIE_DNN_3B_FOLD3
...
namespace TMVA_SOFIE_DNN_3b_fold3{
namespace BLAS{
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "DNN_3b_fold3.dat";
   std::ifstream f;
   f.open(filename);
   if (!f.is_open()){
...
} //TMVA_SOFIE_DNN_3b_fold3

#endif  // TMVA_SOFIE_DNN_3B_FOLD3
