...
do
    ...
    do
        ...
        tmux new-session -d -s $MASS\_${channel}\_Scan2D "python3 runlimits.py --year run2 --channel ${channel} --region C --datacard_dir ${datacarddir} --outputdir ${outdir} --POI_name ${POI}  --Masses ${MASS};"
    done
done
