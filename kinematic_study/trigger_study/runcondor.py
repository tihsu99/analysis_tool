      ...
      for variation in ['nominal', 'nPV_up', 'nPV_down', 'nJet_up', 'nJet_down']:
       ...
       for dataset in file_dict:
         for iin in file_dict[dataset]:
           ...
           if(args.check):
                fname = os.path.join(Outdir, Era, variation, "{}_{}_{}".format(region, lepton, iin))
                ...
                try:
                   ...
                   #cprint(e, 'red')
                   cprint('reproduce {}'.format(fname), 'yellow')
           ...
           print(Era, region, lepton, variation)
  ##################
  ##  Submit Job  ##
  ##################
  cprint(Check_GreenLight, 'yellow')
  condor.close()
