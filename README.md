...
```
source example/IntegrateResults.sh # Note: You should already have all the results for limits.
```
...
Let's say if your original output folder was: /your/output/folder/for/merged/plots_limit:
Then: 
```
