...
parser.add_argument('--unblind', default=False, type = bool)
...
if args.Job_bus_Name=='__default__':
    Write_Shell(WorkDir=WorkDir,channel=args.channel,mode=args.task,higgs=args.higgs,year=args.year,mass_point=args.mass_point,coupling_value=args.coupling_value,outputdir=args.outputdir,Masses=args.Masses,unblind=args.unblind)
else:
