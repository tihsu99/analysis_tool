...
class DataMCCanvas(RatioCanvas):
    ...
    def addSignal(self, sig, title = '', color = 0, idx = -1, drawOpt = 'HIST', lwidth = 4):
        ...
        if idx not in self._sigs:
            ...
            self.legend.add('sig%d' % idx, title = title, opt = 'L', color = color, lwidth = lwidth, lstyle = ROOT.kSolid, fstyle = 0)
